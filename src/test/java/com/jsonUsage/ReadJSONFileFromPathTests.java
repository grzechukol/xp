...
public class ReadJSONFileFromPathTests {
    ...
    void showGetJsonFilePath() throws WrongJsonPathException {
        ...
        String testFilePath = testReadJSONFileFromPath.getJsonFilePath("C:\\Users\\Lenovo\\IdeaProjects\\xp\\src\\main\\resources\\configFile.json");
        ...
        if (subOS.equals("Windows")) {
            ...
            assertEquals(projectDirectory + "/src/main/resources/configFile.json", testFilePath);
        }
